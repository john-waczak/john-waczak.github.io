...
\end{equation}
Noticing that $\frac{1}{f}\frac{df}{dx}=\frac{d \ln(f(x))}{d x}$ by reverse
application of the chain rule, we can rewrite the equation as
\begin{equation}
  \frac{\partial \ln g_1}{\partial U_1} = \frac{\partial \ln g_2}{\partial U_2}
\end{equation}

These quantities are equal for systems in thermal equilibrium so we should give
...
The punchline of our derivation is \textbf{Two systems are in equilibrium when
 the slopes of their S vs U graphs are the same.}
