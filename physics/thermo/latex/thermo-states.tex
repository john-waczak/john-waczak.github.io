...
The \textbf{fundamental assumption} we make when doing statistical physics is
that a closed system can be found in any of the quantum states accessible to it
